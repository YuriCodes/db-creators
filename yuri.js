    ...
    (() => {
        var e,
            ...
            s = {
                982: (e, t, s) => {
                    "use strict";
                    s.r(t), s.d(t, { FunctionsClient: () => a, FunctionsError: () => r, FunctionsFetchError: () => i, FunctionsHttpError: () => o, FunctionsRelayError: () => n });
                            ...
                            return (
                                ...
                                (h = function* () {
                                    try {
                                        ...
                                        const u = yield this.fetch(`${this.url}/${e}`, { method: a || "POST", headers: Object.assign(Object.assign(Object.assign({}, l), this.headers), r), body: h }).catch((e) => {
                                                throw new i(e);
                                            }),
                                        ...
                                        let f,
                                            p = (null !== (s = u.headers.get("Content-Type")) && void 0 !== s ? s : "text/plain").split(";")[0].trim();
                                        return (
                                            (f = "application/json" === p ? yield u.json() : "application/octet-stream" === p ? yield u.blob() : "multipart/form-data" === p ? yield u.formData() : yield u.text()), { data: f, error: null }
                                        );
                                    } catch (e) {
                ...
                765: (e, t, s) => {
                    ...
                    const r = () => "undefined" != typeof document,
                        ...
                        n = () => {
                            ...
                            try {
                                globalThis.localStorage.setItem(e, e), globalThis.localStorage.removeItem(e), (i.tested = !0), (i.writable = !0);
                            } catch (e) {
                    ...
                    const a = (e) => {
                        ...
                        c = (e) => "object" == typeof e && null !== e && "status" in e && "ok" in e && "json" in e && "function" == typeof e.json,
                        h = async (e, t, s) => {
                    ...
                    const x = (e) => e.msg || e.message || e.error_description || e.error || JSON.stringify(e),
                        C = [502, 503, 504];
                    async function A(e) {
                        ...
                        const a = Object.keys(o).length ? "?" + new URLSearchParams(o).toString() : "",
                            c = await (async function (e, t, s, r, i, n) {
                                const o = ((e, t, s, r) => {
                                    ...
                                    return "GET" === e
                                        ? i
                                        : ((i.headers = Object.assign({ "Content-Type": "application/json;charset=UTF-8" }, null == t ? void 0 : t.headers)), (i.body = JSON.stringify(r)), Object.assign(Object.assign({}, i), s));
                                })(t, r, {}, n);
                                let a;
                                try {
                                    a = await e(s, o);
                            ...
                            })(e, t, s + a, { headers: n, noResolveJson: null == r ? void 0 : r.noResolveJson }, 0, null == r ? void 0 : r.body);
                        return (null == r ? void 0 : r.xform) ? (null == r ? void 0 : r.xform(c)) : { data: Object.assign({}, c), error: null };
                    }
                    function I(e) {
                        var t;
                        let s = null;
                    ...
                    function N(e) {
                        ...
                        return { data: { properties: { action_link: t, email_otp: s, hashed_token: r, redirect_to: i, verification_type: n }, user: Object.assign({}, o) }, error: null };
                    }
                    function D(e) {
                        return e;
                    }
                    class F {
                        constructor({ url: e = "", headers: t = {}, fetch: s }) {
                            (this.url = e), (this.headers = t), (this.fetch = a(s)), (this.mfa = { listFactors: this._listFactors.bind(this), deleteFactor: this._deleteFactor.bind(this) });
                        }
                        async signOut(e, t = "global") {
                            try {
                                return await R(this.fetch, "POST", `${this.url}/logout?scope=${t}`, { headers: this.headers, jwt: e, noResolveJson: !0 }), { data: null, error: null };
                            } catch (e) {
                        ...
                        async inviteUserByEmail(e, t = {}) {
                            try {
                                return await R(this.fetch, "POST", `${this.url}/invite`, { body: { email: e, data: t.data }, headers: this.headers, redirectTo: t.redirectTo, xform: L });
                            } catch (e) {
                        ...
                        async generateLink(e) {
                            try {
                                ...
                                return (
                                    ...
                                    await R(this.fetch, "POST", `${this.url}/admin/generate_link`, { body: r, headers: this.headers, xform: N, redirectTo: null == t ? void 0 : t.redirectTo })
                                );
                            } catch (e) {
                        ...
                        async createUser(e) {
                            try {
                                return await R(this.fetch, "POST", `${this.url}/admin/users`, { body: e, headers: this.headers, xform: L });
                            } catch (e) {
                                if (v(e)) return { data: { user: null }, error: e };
                                throw e;
                            }
                        ...
                        async listUsers(e) {
                            ...
                            try {
                                ...
                                const l = await h.json(),
                                    ...
                                    d = null !== (a = null === (o = h.headers.get("link")) || void 0 === o ? void 0 : o.split(",")) && void 0 !== a ? a : [];
                                return (
                                    d.length > 0 &&
                                        (d.forEach((e) => {
                        ...
                        async getUserById(e) {
                            try {
                                return await R(this.fetch, "GET", `${this.url}/admin/users/${e}`, { headers: this.headers, xform: L });
                            } catch (e) {
                                if (v(e)) return { data: { user: null }, error: e };
                                throw e;
                            }
                        ...
                        async updateUserById(e, t) {
                            try {
                                return await R(this.fetch, "PUT", `${this.url}/admin/users/${e}`, { body: t, headers: this.headers, xform: L });
                            } catch (e) {
                                if (v(e)) return { data: { user: null }, error: e };
                                throw e;
                            }
                        ...
                        async deleteUser(e, t = !1) {
                            try {
                                return await R(this.fetch, "DELETE", `${this.url}/admin/users/${e}`, { headers: this.headers, body: { should_soft_delete: t }, xform: L });
                            } catch (e) {
                                if (v(e)) return { data: { user: null }, error: e };
                                throw e;
                            }
                        ...
                        async _listFactors(e) {
                            try {
                                const { data: t, error: s } = await R(this.fetch, "GET", `${this.url}/admin/users/${e.userId}/factors`, { headers: this.headers, xform: (e) => ({ data: { factors: e }, error: null }) });
                        ...
                        async _deleteFactor(e) {
                            try {
                                return { data: await R(this.fetch, "DELETE", `${this.url}/admin/users/${e.userId}/factors/${e.id}`, { headers: this.headers }), error: null };
                            } catch (e) {
                                if (v(e)) return { data: null, error: e };
                                throw e;
                            }
                    ...
                    const z = { debug: !!(globalThis && n() && globalThis.localStorage && "true" === globalThis.localStorage.getItem("supabase.gotrue-js.locks.debug")) };
                    ...
                    async function K(e, t, s) {
                        ...
                        return (
                            ...
                            await globalThis.navigator.locks.request(e, 0 === t ? { mode: "exclusive", ifAvailable: !0 } : { mode: "exclusive", signal: r.signal }, async (r) => {
                                if (!r) {
                                    if (0 === t) throw (z.debug && console.log("@supabase/gotrue-js: navigatorLock: not immediately available", e), new H(`Acquiring an exclusive Navigator LockManager lock "${e}" immediately failed`));
                                    if (z.debug)
                                        try {
                    ...
                    const V = { url: "http://localhost:9999", storageKey: "supabase.auth.token", autoRefreshToken: !0, persistSession: !0, detectSessionInUrl: !0, headers: q, flowType: "implicit", debug: !1 },
                        W = 3e4;
                    ...
                    class X {
                        ...
                        _debug(...e) {
                            return this.logDebugMessages && this.logger(`GoTrueClient@${this.instanceID} (${M}) ${new Date().toISOString()}`, ...e), this;
                        }
                        async initialize() {
                        ...
                        async _initialize() {
                            try {
                                ...
                                if ((this._debug("#_initialize()", "begin", "is PKCE flow", e), e || (this.detectSessionInUrl && this._isImplicitGrantFlow()))) {
                                    ...
                                    if (s) return this._debug("#_initialize()", "error detecting session from URL", s), await this._removeSession(), { error: s };
                                ...
                                return v(e) ? { error: e } : { error: new w("Unexpected error during initialization", e) };
                            } finally {
                            ...
                            try {
                                ...
                                if ((await this._removeSession(), "email" in e)) {
                                    ...
                                    if ("pkce" === this.flowType) {
                                        const e = g();
                                        await h(this.storage, `${this.storageKey}-code-verifier`, e), (o = await m(e)), (a = e === o ? "plain" : "s256");
                                    }
                                    ...
                                    if (!("phone" in e)) throw new E("You must provide either an email or phone number and a password");
                                    {
                                        ...
                                        i = await R(this.fetch, "POST", `${this.url}/signup`, {
                                            ...
                                            body: {
                                                ...
                                                channel: null !== (r = null == o ? void 0 : o.channel) && void 0 !== r ? r : "sms",
                                ...
                                const a = n.session,
                                    c = n.user;
                                return n.session && (await this._saveSession(n.session), await this._notifyAllSubscribers("SIGNED_IN", a)), { data: { user: c, session: a }, error: null };
                            } catch (e) {
                            ...
                            try {
                                ...
                                if ((await this._removeSession(), "email" in e)) {
                                    ...
                                    t = await R(this.fetch, "POST", `${this.url}/token?grant_type=password`, {
                                        headers: this.headers,
                                        body: { email: s, password: r, gotrue_meta_security: { captcha_token: null == i ? void 0 : i.captchaToken } },
                                        xform: I,
                                    });
                                } else {
                                    if (!("phone" in e)) throw new E("You must provide either an email or phone number and a password");
                                    {
                                        ...
                                        t = await R(this.fetch, "POST", `${this.url}/token?grant_type=password`, {
                                            headers: this.headers,
                                            body: { phone: s, password: r, gotrue_meta_security: { captcha_token: null == i ? void 0 : i.captchaToken } },
                                            xform: I,
                                        });
                                    }
                                }
                                ...
                                return r
                                    ...
                                    : s && s.session && s.user
                                    ? (s.session && (await this._saveSession(s.session), await this._notifyAllSubscribers("SIGNED_IN", s.session)), { data: { user: s.user, session: s.session }, error: r })
                        ...
                        async _exchangeCodeForSession(e) {
                            const t = await l(this.storage, `${this.storageKey}-code-verifier`),
                                { data: s, error: r } = await R(this.fetch, "POST", `${this.url}/token?grant_type=pkce`, { headers: this.headers, body: { auth_code: e, code_verifier: t }, xform: I });
                            return (
                                await u(this.storage, `${this.storageKey}-code-verifier`),
                                r
                                    ? { data: { user: null, session: null }, error: r }
                                    : s && s.session && s.user
                                    ? (s.session && (await this._saveSession(s.session), await this._notifyAllSubscribers("SIGNED_IN", s.session)), { data: s, error: r })
                                    : { data: { user: null, session: null }, error: new T() }
                            );
                        }
                        async signInWithIdToken(e) {
                            ...
                            try {
                                ...
                                return c
                                    ...
                                    : a && a.session && a.user
                                    ? (a.session && (await this._saveSession(a.session), await this._notifyAllSubscribers("SIGNED_IN", a.session)), { data: a, error: c })
                                    : { data: { user: null, session: null }, error: new T() };
                            } catch (e) {
                                if (v(e)) return { data: { user: null, session: null }, error: e };
                                throw e;
                        ...
                        async signInWithOtp(e) {
                            ...
                            try {
                                if ((await this._removeSession(), "email" in e)) {
                                    ...
                                    if ("pkce" === this.flowType) {
                                        const e = g();
                                        await h(this.storage, `${this.storageKey}-code-verifier`, e), (n = await m(e)), (o = e === n ? "plain" : "s256");
                                    }
                                ...
                                if ("phone" in e) {
                                    ...
                                    return { data: { user: null, session: null, messageId: null == o ? void 0 : o.message_id }, error: a };
                                }
                        ...
                        async verifyOtp(e) {
                            ...
                            try {
                                ...
                                const a = n.session,
                                    c = n.user;
                                return (null == a ? void 0 : a.access_token) && (await this._saveSession(a), await this._notifyAllSubscribers("SIGNED_IN", a)), { data: { user: c, session: a }, error: null };
                            } catch (e) {
                                if (v(e)) return { data: { user: null, session: null }, error: e };
                                throw e;
                            }
                        ...
                        async _reauthenticate() {
                            try {
                                return await this._useSession(async (e) => {
                                    ...
                                    if (s) throw s;
                                    if (!t) throw new S();
                                    const { error: r } = await R(this.fetch, "GET", `${this.url}/reauthenticate`, { headers: this.headers, jwt: t.access_token });
                            ...
                            try {
                                ...
                                if ("phone" in e) {
                                    const { phone: s, type: r, options: i } = e,
                                        { data: n, error: o } = await R(this.fetch, "POST", t, { headers: this.headers, body: { phone: s, type: r, gotrue_meta_security: { captcha_token: null == i ? void 0 : i.captchaToken } } });
                                    return { data: { user: null, session: null, messageId: null == n ? void 0 : n.message_id }, error: o };
                                }
                        ...
                        async __loadSession() {
                            ...
                            try {
                                ...
                                if (
                                    ...
                                    null !== t && (this._isValidSession(t) ? (e = t) : (this._debug("#getSession()", "session from storage is not valid"), await this._removeSession())),
                                    !e)
                                )
                                    return { data: { session: null }, error: null };
                                const s = !!e.expires_at && e.expires_at <= Date.now() / 1e3;
                                if ((this._debug("#__loadSession()", `session has${s ? "" : " not"} expired`, "expires_at", e.expires_at), !s)) return { data: { session: e }, error: null };
                        ...
                        async _getUser(e) {
                            try {
                                return e
                                    ? await R(this.fetch, "GET", `${this.url}/user`, { headers: this.headers, jwt: e, xform: L })
                        ...
                        async _updateUser(e, t = {}) {
                            try {
                                return await this._useSession(async (s) => {
                                    ...
                                    if (l) throw l;
                                    return (n.user = c.user), await this._saveSession(n), await this._notifyAllSubscribers("USER_UPDATED", n), { data: { user: n.user }, error: null };
                                });
                            } catch (e) {
                                if (v(e)) return { data: { user: null }, error: e };
                                throw e;
                        ...
                        async _setSession(e) {
                            try {
                                ...
                                if ((n.exp && ((s = n.exp), (r = s <= t)), r)) {
                                    ...
                                    if (n) throw n;
                                    (i = { access_token: e.access_token, refresh_token: e.refresh_token, user: r.user, token_type: "bearer", expires_in: s - t, expires_at: s }),
                        ...
                        async _getSessionFromURL(e) {
                            try {
                                ...
                                if ("implicit" === this.flowType && !this._isImplicitGrantFlow()) throw new j("Not a valid implicit grant flow url.");
                                ...
                                if (t.error || t.error_description || t.error_code)
                                    throw new j(t.error_description || "Error in URL with unspecified error_description", { error: t.error || "unspecified_error", code: t.error_code || "unspecified_code" });
                                const { provider_token: s, provider_refresh_token: i, access_token: n, refresh_token: a, expires_in: c, expires_at: h, token_type: l } = t;
                                ...
                                h && (f = parseInt(h));
                                const p = f - u;
                                1e3 * p <= W && console.warn(`@supabase/gotrue-js: Session as retrieved from URL expires in ${p}s, should have been closer to ${d}s`);
                                const g = f - d;
                                u - g >= 120
                                    ? console.warn("@supabase/gotrue-js: Session as retrieved from URL was issued over 120s ago, URL could be stale", g, f, u)
                                    : u - g < 0 && console.warn("@supabase/gotrue-js: Session as retrieved from URL was issued in the future? Check the device clok for skew", g, f, u);
                                const { data: m, error: y } = await this._getUser(n);
                                if (y) throw y;
                                const v = { provider_token: s, provider_refresh_token: i, access_token: n, expires_in: d, expires_at: f, refresh_token: a, token_type: l, user: m.user };
                        ...
                        async _signOut({ scope: e } = { scope: "global" }) {
                            return await this._useSession(async (t) => {
                                ...
                                return "others" !== e && (await this._removeSession(), await u(this.storage, `${this.storageKey}-code-verifier`), await this._notifyAllSubscribers("SIGNED_OUT", null)), { error: null };
                            });
                        }
                        onAuthStateChange(e) {
                        ...
                        async resetPasswordForEmail(e, t = {}) {
                            ...
                            if ("pkce" === this.flowType) {
                                const e = g();
                                await h(this.storage, `${this.storageKey}-code-verifier`, e), (s = await m(e)), (r = e === s ? "plain" : "s256");
                            }
                            try {
                                return await R(this.fetch, "POST", `${this.url}/recover`, {
                                    body: { email: e, code_challenge: s, code_challenge_method: r, gotrue_meta_security: { captcha_token: t.captchaToken } },
                                    headers: this.headers,
                        ...
                        async _refreshAccessToken(e) {
                            ...
                            try {
                                ...
                                return await ((s = async (s) => (
                                    ...
                                    await R(this.fetch, "POST", `${this.url}/token?grant_type=refresh_token`, { body: { refresh_token: e }, headers: this.headers, xform: I })
                                )),
                                ...
                                if ((this._debug(t, "error", e), v(e))) return { data: { session: null, user: null }, error: e };
                                throw e;
                            } finally {
                                this._debug(t, "end");
                            }
                        ...
                        async _handleProviderSignIn(e, t) {
                            const s = await this._getUrlForProvider(e, { redirectTo: t.redirectTo, scopes: t.scopes, queryParams: t.queryParams });
                            return this._debug("#_handleProviderSignIn()", "provider", e, "options", t, "url", s), r() && !t.skipBrowserRedirect && window.location.assign(s), { data: { provider: e, url: s }, error: null };
                        }
                            ...
                            try {
                                ...
                                if ((this._debug(t, `session has${i ? "" : " not"} expired with margin of 10s`), i)) {
                                    if (this.autoRefreshToken && s.refresh_token) {
                                        ...
                                        e && (console.error(e), $(e) || (this._debug(t, "refresh failed with a non-retryable error, removing the session", e), await this._removeSession()));
                                    }
                        ...
                        _removeVisibilityChangedCallback() {
                            ...
                            this.visibilityChangedCallback = null;
                            try {
                                e && r() && (null === window || void 0 === window ? void 0 : window.removeEventListener) && window.removeEventListener("visibilitychange", e);
                            } catch (e) {
                        ...
                        async _handleVisibilityChange() {
                            if ((this._debug("#_handleVisibilityChange()"), !r() || !(null === window || void 0 === window ? void 0 : window.addEventListener))) return this.autoRefreshToken && this.startAutoRefresh(), !1;
                            try {
                        ...
                        async _getUrlForProvider(e, t) {
                            ...
                            if (
                                ((null == t ? void 0 : t.redirectTo) && s.push(`redirect_to=${encodeURIComponent(t.redirectTo)}`),
                                ...
                                const i = new URLSearchParams({ code_challenge: `${encodeURIComponent(t)}`, code_challenge_method: `${encodeURIComponent(r)}` });
                                s.push(i.toString());
                            }
                        ...
                        async _unenroll(e) {
                            try {
                                return await this._useSession(async (t) => {
                                    ...
                                    return i
                                        ? { data: null, error: i }
                                        : await R(this.fetch, "DELETE", `${this.url}/factors/${e.factorId}`, { headers: this.headers, jwt: null === (s = null == r ? void 0 : r.session) || void 0 === s ? void 0 : s.access_token });
                                });
                            } catch (e) {
                                if (v(e)) return { data: null, error: e };
                                throw e;
                        ...
                        async _enroll(e) {
                            try {
                                return await this._useSession(async (t) => {
                                    ...
                                    return a
                                        ? { data: null, error: a }
                                        : ((null === (r = null == o ? void 0 : o.totp) || void 0 === r ? void 0 : r.qr_code) && (o.totp.qr_code = `data:image/svg+xml;utf-8,${o.totp.qr_code}`), { data: o, error: null });
                                });
                            } catch (e) {
                                if (v(e)) return { data: null, error: e };
                                throw e;
                            ...
                            return this._acquireLock(-1, async () => {
                                try {
                                    return await this._useSession(async (t) => {
                                        ...
                                        const { data: n, error: o } = await R(this.fetch, "POST", `${this.url}/factors/${e.factorId}/verify`, {
                                        ...
                                        return o
                                            ? { data: null, error: o }
                                            : (await this._saveSession(Object.assign({ expires_at: Math.round(Date.now() / 1e3) + n.expires_in }, n)), await this._notifyAllSubscribers("MFA_CHALLENGE_VERIFIED", n), { data: n, error: o });
                                    });
                                } catch (e) {
                                    if (v(e)) return { data: null, error: e };
                                    throw e;
                            ...
                            return this._acquireLock(
                                ...
                                async () =>
                                    await this._useSession(async (e) => {
                                        ...
                                        let a = o;
                                        return (
                                            (null !== (s = null === (t = r.user.factors) || void 0 === t ? void 0 : t.filter((e) => "verified" === e.status)) && void 0 !== s ? s : []).length > 0 && (a = "aal2"),
                                            { data: { currentLevel: o, nextLevel: a, currentAuthenticationMethods: n.amr || [] }, error: null }
                                        );
                                    })
                            );
                        }
                ...
                189: (e, t, s) => {
                    "use strict";
                    s.r(t), s.d(t, { PostgrestBuilder: () => n, PostgrestClient: () => l, PostgrestFilterBuilder: () => a, PostgrestQueryBuilder: () => c, PostgrestTransformBuilder: () => o });
                    var r = s(743),
                        i = s.n(r);
                    class n {
                        constructor(e) {
                            (this.shouldThrowOnError = !1),
                                ...
                                e.fetch ? (this.fetch = e.fetch) : "undefined" == typeof fetch ? (this.fetch = i()) : (this.fetch = fetch);
                        }
                        throwOnError() {
                        ...
                        then(e, t) {
                            ...
                            let s = (0, this.fetch)(this.url.toString(), { method: this.method, headers: this.headers, body: JSON.stringify(this.body), signal: this.signal }).then(async (e) => {
                                ...
                                if (e.ok) {
                                    ...
                                    const t = await e.text();
                                    try {
                                        (i = JSON.parse(t)), Array.isArray(i) && 404 === e.status && ((n = []), (i = null), (a = 200), (c = "OK"));
                                    } catch (s) {
                                        404 === e.status && "" === t ? ((a = 204), (c = "No Content")) : (i = { message: t });
                                    }
                                    if (
                                        (i && this.isMaybeSingle && (null === (r = null == i ? void 0 : i.details) || void 0 === r ? void 0 : r.includes("Results contain 0 rows")) && ((i = null), (a = 200), (c = "OK")),
                    ...
                    class o extends n {
                        ...
                        order(e, { ascending: t = !0, nullsFirst: s, foreignTable: r } = {}) {
                            ...
                            return this.url.searchParams.set(i, `${n ? `${n},` : ""}${e}.${t ? "asc" : "desc"}${void 0 === s ? "" : s ? ".nullsfirst" : ".nullslast"}`), this;
                        }
                        ...
                        range(e, t, { foreignTable: s } = {}) {
                            ...
                            return this.url.searchParams.set(r, `${e}`), this.url.searchParams.set(i, "" + (t - e + 1)), this;
                        }
                        abortSignal(e) {
                    ...
                    class a extends o {
                        ...
                        in(e, t) {
                            const s = t.map((e) => ("string" == typeof e && new RegExp("[,()]").test(e) ? `"${e}"` : `${e}`)).join(",");
                            return this.url.searchParams.append(e, `in.(${s})`), this;
                        }
                        contains(e, t) {
                            return (
                                "string" == typeof t ? this.url.searchParams.append(e, `cs.${t}`) : Array.isArray(t) ? this.url.searchParams.append(e, `cs.{${t.join(",")}}`) : this.url.searchParams.append(e, `cs.${JSON.stringify(t)}`), this
                            );
                        }
                        containedBy(e, t) {
                            return (
                                "string" == typeof t ? this.url.searchParams.append(e, `cd.${t}`) : Array.isArray(t) ? this.url.searchParams.append(e, `cd.{${t.join(",")}}`) : this.url.searchParams.append(e, `cd.${JSON.stringify(t)}`), this
                            );
                        }
                        rangeGt(e, t) {
                    ...
                    class c {
                        ...
                        select(e, { head: t = !1, count: s } = {}) {
                            ...
                            const n = (null != e ? e : "*")
                                ...
                                .join("");
                            return this.url.searchParams.set("select", n), s && (this.headers.Prefer = `count=${s}`), new a({ method: r, url: this.url, headers: this.headers, schema: this.schema, fetch: this.fetch, allowEmpty: !1 });
                        }
                        insert(e, { count: t, defaultToNull: s = !0 } = {}) {
                            ...
                            return new a({ method: "POST", url: this.url, headers: this.headers, schema: this.schema, body: e, fetch: this.fetch, allowEmpty: !1 });
                        }
                        ...
                        update(e, { count: t } = {}) {
                            ...
                            return (
                                ...
                                new a({ method: "PATCH", url: this.url, headers: this.headers, schema: this.schema, body: e, fetch: this.fetch, allowEmpty: !1 })
                            );
                        }
                        delete({ count: e } = {}) {
                            const t = [];
                            return (
                                ...
                                new a({ method: "DELETE", url: this.url, headers: this.headers, schema: this.schema, fetch: this.fetch, allowEmpty: !1 })
                            );
                        }
                    }
                    ...
                    class l {
                        constructor(e, { headers: t = {}, schema: s, fetch: r } = {}) {
                            (this.url = e), (this.headers = Object.assign(Object.assign({}, h), t)), (this.schemaName = s), (this.fetch = r);
                        }
                        from(e) {
                            const t = new URL(`${this.url}/${e}`);
                            return new c(t, { headers: Object.assign({}, this.headers), schema: this.schemaName, fetch: this.fetch });
                        }
                        schema(e) {
                        ...
                        rpc(e, t = {}, { head: s = !1, count: r } = {}) {
                            ...
                            return r && (c.Prefer = `count=${r}`), new a({ method: i, url: n, headers: c, schema: this.schemaName, body: o, fetch: this.fetch, allowEmpty: !1 });
                        }
                    }
                },
                73: (e, t, s) => {
                    ...
                    class f {
                        ...
                        _decodeBroadcast(e, t, s) {
                            ...
                            return (n += i), { ref: null, topic: o, event: a, payload: JSON.parse(s.decode(e.slice(n, e.byteLength))) };
                        }
                    }
                    class p {
                        ...
                        send() {
                            this._hasReceived("timeout") ||
                                (this.startTimeout(),
                                (this.sent = !0),
                                "rate limited" === this.channel.socket.push({ topic: this.channel.topic, event: this.event, payload: this.payload, ref: this.ref, join_ref: this.channel._joinRef() }) && (this.rateLimited = !0));
                        }
                        updatePayload(e) {
                        ...
                        constructor(e, t) {
                            ...
                            this.channel._on(s.state, {}, (e) => {
                                ...
                                this.channel._on(s.diff, {}, (e) => {
                                    const { onJoin: t, onLeave: s, onSync: r } = this.caller;
                                    this.inPendingSyncState() ? this.pendingDiffs.push(e) : ((this.state = g.syncDiff(this.state, e, t, s)), r());
                                }),
                                this.onJoin((e, t, s) => {
                    ...
                    class P {
                        constructor(e, t = { config: {} }, s) {
                            (this.topic = e),
                                ...
                                (this.params.config = Object.assign({ broadcast: { ack: !1, self: !1 }, presence: { key: "" } }, t.config)),
                                (this.timeout = this.socket.timeout),
                                (this.joinPush = new p(this, a.join, this.params, this.timeout)),
                                (this.rejoinTimer = new d(() => this._rejoinUntilConnected(), this.socket.reconnectAfterMs)),
                                this.joinPush.receive("ok", () => {
                                    (this.state = o.joined), this.rejoinTimer.reset(), this.pushBuffer.forEach((e) => e.send()), (this.pushBuffer = []);
                                }),
                                this._onClose(() => {
                                ...
                                this._onError((e) => {
                                    this._isLeaving() || this._isClosed() || (this.socket.log("channel", `error ${this.topic}`, e), (this.state = o.errored), this.rejoinTimer.scheduleTimeout());
                                }),
                        ...
                        subscribe(e, t = this.timeout) {
                            ...
                            if ((this.socket.isConnected() || this.socket.connect(), this.joinedOnce)) throw "tried to subscribe multiple times. 'subscribe' can only be called a single time per channel instance";
                            {
                                ...
                                const o = {},
                                    a = { broadcast: i, presence: n, postgres_changes: null !== (r = null === (s = this.bindings.postgres_changes) || void 0 === s ? void 0 : s.map((e) => e.filter)) && void 0 !== r ? r : [] };
                                            ...
                                            if ((this.socket.accessToken && this.socket.setAuth(this.socket.accessToken), void 0 !== t)) {
                                                ...
                                                for (let s = 0; s < i; s++) {
                                                    const i = r[s],
                                                        ...
                                                        l = t && t[s];
                                                    if (!l || l.event !== o || l.schema !== a || l.table !== c || l.filter !== h)
                                                        return this.unsubscribe(), void (e && e("CHANNEL_ERROR", new Error("mismatch between server and client bindings for postgres changes")));
                        ...
                        async send(e, t = {}) {
                            ...
                            if (this._canPush() || "broadcast" !== e.type)
                                return new Promise((s) => {
                                    ...
                                    o.rateLimited && s("rate limited"),
                                        "broadcast" !== e.type ||
                                            (null === (n = null === (i = null === (r = this.params) || void 0 === r ? void 0 : r.config) || void 0 === i ? void 0 : i.broadcast) || void 0 === n ? void 0 : n.ack) ||
                                            s("ok"),
                                        o.receive("ok", () => s("ok")),
                                ...
                                });
                            {
                                const { event: i, payload: n } = e,
                                    o = {
                                        method: "POST",
                                        headers: { apikey: null !== (s = this.socket.accessToken) && void 0 !== s ? s : "", "Content-Type": "application/json" },
                                        body: JSON.stringify({ messages: [{ topic: this.subTopic, event: i, payload: n }] }),
                                    };
                                try {
                                    return (await this._fetchWithTimeout(this.broadcastEndpointURL, o, null !== (r = t.timeout) && void 0 !== r ? r : this.timeout)).ok ? "ok" : "error";
                                } catch (e) {
                        ...
                        unsubscribe(e = this.timeout) {
                            ...
                            const t = () => {
                                this.socket.log("channel", `leave ${this.topic}`), this._trigger(a.close, "leave", this._joinRef());
                            };
                            return (
                                  ...
                                  r
                                      .filter((e) => {
                                          ...
                                          return (
                                              ...
                                              (null === (r = null === (s = e.filter) || void 0 === s ? void 0 : s.event) || void 0 === r ? void 0 : r.toLocaleLowerCase()) === n
                                          );
                                      })
                                          ...
                                          if (["broadcast", "presence", "postgres_changes"].includes(n)) {
                                              if ("id" in e) {
                                                  ...
                                                  return (
                                                      ...
                                                      ("*" === o || (null == o ? void 0 : o.toLocaleLowerCase()) === (null === (i = t.data) || void 0 === i ? void 0 : i.type.toLocaleLowerCase()))
                                                  );
                                              }
                                              {
                                                  const s = null === (a = null === (o = null == e ? void 0 : e.filter) || void 0 === o ? void 0 : o.event) || void 0 === a ? void 0 : a.toLocaleLowerCase();
                                      ...
                                      .map((e) => {
                                          if ("object" == typeof u && "ids" in u) {
                                              const e = u.data,
                                                  ...
                                                  o = { schema: t, table: s, commit_timestamp: r, eventType: i, new: {}, old: {}, errors: n };
                        ...
                        _off(e, t) {
                            ...
                            return (
                                (this.bindings[s] = this.bindings[s].filter((e) => {
                                    var r;
                                    return !((null === (r = e.type) || void 0 === r ? void 0 : r.toLocaleLowerCase()) === s && P.isEqual(e.filter, t));
                                })),
                                this
                            );
                        }
                    ...
                    class x {
                        constructor(e, t) {
                            ...
                            const h = null === (o = null == t ? void 0 : t.params) || void 0 === o ? void 0 : o.apikey;
                        ...
                        setAuth(e) {
                            (this.accessToken = e),
                                this.channels.forEach((t) => {
                                    e && t.updateJoinPayload({ access_token: e }), t.joinedOnce && t._isJoined() && t._push(a.access_token, { access_token: e });
                                });
                        }
                        _makeRef() {
                            let e = this.ref + 1;
                ...
                752: (e, t, s) => {
                    "use strict";
                    s.r(t), s.d(t, { StorageApiError: () => n, StorageClient: () => S, StorageError: () => r, StorageUnknownError: () => o, isStorageError: () => i });
                    class r extends Error {
                        constructor(e) {
                    ...
                    const h = (e) => e.msg || e.message || e.error_description || e.error || JSON.stringify(e),
                        l = (e, t) =>
                            c(void 0, void 0, void 0, function* () {
                                ...
                                (c = void 0),
                                (l = function* () {
                                    return "undefined" == typeof Response ? (yield Promise.resolve().then(s.t.bind(s, 743, 23))).Response : Response;
                                }),
                    ...
                    class _ {
                            ...
                            return m(this, void 0, void 0, function* () {
                                try {
                                    ...
                                    const n = Object.assign(Object.assign({}, v), r),
                                        o = Object.assign(Object.assign({}, this.headers), "POST" === e && { "x-upsert": String(n.upsert) });
                                    "undefined" != typeof Blob && s instanceof Blob
                                        ...
                                        : ((i = s), (o["cache-control"] = `max-age=${n.cacheControl}`), (o["content-type"] = n.contentType));
                                    const a = this._removeEmptyFolders(t),
                                        c = this._getFinalPath(a),
                                        h = yield this.fetch(`${this.url}/object/${c}`, Object.assign({ method: e, body: i, headers: o }, (null == n ? void 0 : n.duplex) ? { duplex: n.duplex } : {}));
                                    return h.ok ? { data: { path: a }, error: null } : { data: null, error: yield h.json() };
                                } catch (e) {
                            ...
                            return m(this, void 0, void 0, function* () {
                                ...
                                try {
                                    ...
                                    "undefined" != typeof Blob && s instanceof Blob
                                        ...
                                        : ((e = s), (i["cache-control"] = `max-age=${t.cacheControl}`), (i["content-type"] = t.contentType));
                                    const o = yield this.fetch(a.toString(), { method: "PUT", body: e, headers: i });
                                    return o.ok ? { data: { path: n }, error: null } : { data: null, error: yield o.json() };
                                } catch (e) {
                                    if (i(e)) return { data: null, error: e };
                                    throw e;
                                }
                        ...
                        createSignedUploadUrl(e) {
                            return m(this, void 0, void 0, function* () {
                                try {
                                    ...
                                    const s = yield p(this.fetch, `${this.url}/object/upload/sign/${t}`, {}, { headers: this.headers }),
                        ...
                        move(e, t) {
                            return m(this, void 0, void 0, function* () {
                                try {
                                    return { data: yield p(this.fetch, `${this.url}/object/move`, { bucketId: this.bucketId, sourceKey: e, destinationKey: t }, { headers: this.headers }), error: null };
                                } catch (e) {
                                    if (i(e)) return { data: null, error: e };
                                    throw e;
                                }
                        ...
                        copy(e, t) {
                            return m(this, void 0, void 0, function* () {
                                try {
                                    return { data: { path: (yield p(this.fetch, `${this.url}/object/copy`, { bucketId: this.bucketId, sourceKey: e, destinationKey: t }, { headers: this.headers })).Key }, error: null };
                                } catch (e) {
                                    if (i(e)) return { data: null, error: e };
                                    throw e;
                                }
                            ...
                            return m(this, void 0, void 0, function* () {
                                try {
                                    let r = this._getFinalPath(e),
                                        i = yield p(this.fetch, `${this.url}/object/sign/${r}`, Object.assign({ expiresIn: t }, (null == s ? void 0 : s.transform) ? { transform: s.transform } : {}), { headers: this.headers });
                        ...
                        createSignedUrls(e, t, s) {
                            return m(this, void 0, void 0, function* () {
                                try {
                                    const r = yield p(this.fetch, `${this.url}/object/sign/${this.bucketId}`, { expiresIn: t, paths: e }, { headers: this.headers }),
                            ...
                            return m(this, void 0, void 0, function* () {
                                ...
                                try {
                                    const t = this._getFinalPath(e),
                                        r = yield f(this.fetch, `${this.url}/${s}/${t}${n}`, { headers: this.headers, noResolveJson: !0 });
                        ...
                        getPublicUrl(e, t) {
                            ...
                            "" !== o && r.push(o);
                            let a = r.join("&");
                            return "" !== a && (a = `?${a}`), { data: { publicUrl: encodeURI(`${this.url}/${n}/public/${s}${a}`) } };
                        }
                        remove(e) {
                            return m(this, void 0, void 0, function* () {
                                try {
                                    return { data: yield g(this.fetch, `${this.url}/object/${this.bucketId}`, { prefixes: e }, { headers: this.headers }), error: null };
                                } catch (e) {
                                    if (i(e)) return { data: null, error: e };
                                    throw e;
                                }
                        ...
                        list(e, t, s) {
                            return m(this, void 0, void 0, function* () {
                                try {
                                    const r = Object.assign(Object.assign(Object.assign({}, y), t), { prefix: e || "" });
                                    return { data: yield p(this.fetch, `${this.url}/object/list/${this.bucketId}`, r, { headers: this.headers }, s), error: null };
                                } catch (e) {
                                    if (i(e)) return { data: null, error: e };
                                    throw e;
                                }
                    ...
                    class k {
                        constructor(e, t = {}, s) {
                            (this.url = e), (this.headers = Object.assign(Object.assign({}, b), t)), (this.fetch = a(s));
                        }
                        listBuckets() {
                            return w(this, void 0, void 0, function* () {
                                try {
                                    return { data: yield f(this.fetch, `${this.url}/bucket`, { headers: this.headers }), error: null };
                                } catch (e) {
                                    if (i(e)) return { data: null, error: e };
                                    throw e;
                                }
                        ...
                        getBucket(e) {
                            return w(this, void 0, void 0, function* () {
                                try {
                                    return { data: yield f(this.fetch, `${this.url}/bucket/${e}`, { headers: this.headers }), error: null };
                                } catch (e) {
                                    if (i(e)) return { data: null, error: e };
                                    throw e;
                                }
                        ...
                        createBucket(e, t = { public: !1 }) {
                            return w(this, void 0, void 0, function* () {
                                try {
                                    return {
                                        data: yield p(this.fetch, `${this.url}/bucket`, { id: e, name: e, public: t.public, file_size_limit: t.fileSizeLimit, allowed_mime_types: t.allowedMimeTypes }, { headers: this.headers }),
                                        error: null,
                                    };
                                } catch (e) {
                                    if (i(e)) return { data: null, error: e };
                        ...
                        emptyBucket(e) {
                            return w(this, void 0, void 0, function* () {
                                try {
                                    return { data: yield p(this.fetch, `${this.url}/bucket/${e}/empty`, {}, { headers: this.headers }), error: null };
                                } catch (e) {
                                    if (i(e)) return { data: null, error: e };
                                    throw e;
                                }
                        ...
                        deleteBucket(e) {
                            return w(this, void 0, void 0, function* () {
                                try {
                                    return { data: yield g(this.fetch, `${this.url}/bucket/${e}`, {}, { headers: this.headers }), error: null };
                                } catch (e) {
                                    if (i(e)) return { data: null, error: e };
                                    throw e;
                                }
                ...
                296: function (e, t, s) {
                    ...
                    t.default = class {
                        constructor(e, t, s) {
                            ...
                            (this.realtimeUrl = `${v}/realtime/v1`.replace(/^http/i, "ws")), (this.authUrl = `${v}/auth/v1`), (this.storageUrl = `${v}/storage/v1`), (this.functionsUrl = `${v}/functions/v1`);
                            const _ = `sb-${new URL(this.authUrl).hostname.split(".")[0]}-auth-token`,
                                b = { db: f, realtime: g, auth: Object.assign(Object.assign({}, p), { storageKey: _ }), global: d },
                                w = (0, l.applySettingDefaults)(null != s ? s : {}, b);
                            (this.storageKey = null !== (i = null === (r = w.auth) || void 0 === r ? void 0 : r.storageKey) && void 0 !== i ? i : ""),
                                (this.headers = null !== (a = null === (o = w.global) || void 0 === o ? void 0 : o.headers) && void 0 !== a ? a : {}),
                                (this.auth = this._initSupabaseAuthClient(null !== (c = w.auth) && void 0 !== c ? c : {}, this.headers, null === (u = w.global) || void 0 === u ? void 0 : u.fetch)),
                                (this.fetch = (0, h.fetchWithAuth)(t, this._getAccessToken.bind(this), null === (m = w.global) || void 0 === m ? void 0 : m.fetch)),
                                (this.realtime = this._initRealtimeClient(Object.assign({ headers: this.headers }, w.realtime))),
                                (this.rest = new n.PostgrestClient(`${v}/rest/v1`, { headers: this.headers, schema: null === (y = w.db) || void 0 === y ? void 0 : y.schema, fetch: this.fetch })),
                                this._listenForAuthEvents();
                        }
                        get functions() {
                            return new i.FunctionsClient(this.functionsUrl, { headers: this.headers, customFetch: this.fetch });
                        }
                        get storage() {
                        ...
                        _initSupabaseAuthClient({ autoRefreshToken: e, persistSession: t, detectSessionInUrl: s, storage: r, storageKey: i, flowType: n, debug: o }, a, c) {
                            const h = { Authorization: `Bearer ${this.supabaseKey}`, apikey: `${this.supabaseKey}` };
                        ...
                        _initRealtimeClient(e) {
                            return new o.RealtimeClient(this.realtimeUrl, Object.assign(Object.assign({}, e), { params: Object.assign({ apikey: this.supabaseKey }, null == e ? void 0 : e.params) }));
                        }
                ...
                341: function (e, t, s) {
                    ...
                    Object.defineProperty(t, "__esModule", { value: !0 }), (t.createClient = t.SupabaseClient = t.FunctionsError = t.FunctionsRelayError = t.FunctionsFetchError = t.FunctionsHttpError = void 0);
                    const o = n(s(296));
                    i(s(765), t);
                    var a = s(982);
                ...
                678: (e, t, s) => {
                    ...
                    const r = s(506);
                    let i = "";
                    (i = "undefined" != typeof Deno ? "deno" : "undefined" != typeof document ? "web" : "undefined" != typeof navigator && "ReactNative" === navigator.product ? "react-native" : "node"),
                ...
                716: function (e, t, s) {
                    ...
                    Object.defineProperty(t, "__esModule", { value: !0 }), (t.fetchWithAuth = t.resolveHeadersConstructor = t.resolveFetch = void 0);
                    const a = n(s(743));
                    (t.resolveFetch = (e) => {
                        let t;
                        return (t = e || ("undefined" == typeof fetch ? a.default : fetch)), (...e) => t(...e);
                    }),
                        (t.resolveHeadersConstructor = () => ("undefined" == typeof Headers ? a.Headers : Headers)),
                        (t.fetchWithAuth = (e, s, r) => {
                            ...
                            return (t, r) =>
                                o(void 0, void 0, void 0, function* () {
                                    ...
                                    return c.has("apikey") || c.set("apikey", e), c.has("Authorization") || c.set("Authorization", `Bearer ${a}`), i(t, Object.assign(Object.assign({}, r), { headers: c }));
                                });
                        });
                },
                610: (e, t) => {
                    ...
                    Object.defineProperty(t, "__esModule", { value: !0 }),
                        ...
                        (t.applySettingDefaults = function (e, t) {
                            ...
                            return { db: Object.assign(Object.assign({}, o), s), auth: Object.assign(Object.assign({}, a), r), realtime: Object.assign(Object.assign({}, c), i), global: Object.assign(Object.assign({}, h), n) };
                        });
                },
                506: (e, t) => {
                    "use strict";
                    Object.defineProperty(t, "__esModule", { value: !0 }), (t.version = void 0), (t.version = "2.37.0");
                },
                840: (e, t, s) => {
                    var r;
        ...
        return (
            ...
            (i.t = function (s, r) {
                ...
                var o = {};
                e = e || [null, t({}), t([]), t(t)];
                for (var a = 2 & r && s; "object" == typeof a && !~e.indexOf(a); a = t(a)) Object.getOwnPropertyNames(a).forEach((e) => (o[e] = () => s[e]));
...
var SUPABASE_URL = 'https://xlrjayxgojcyxqdcgevy.supabase.co'
var SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhscmpheXhnb2pjeXhxZGNnZXZ5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTYyNzEyODYsImV4cCI6MjAxMTg0NzI4Nn0.nyazEPCmZ5EWJpWVa5ntKkC7MQK65dLFdCDGnvW3Tg4'
